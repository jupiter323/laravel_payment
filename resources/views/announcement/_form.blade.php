	<div class="row">	
		<div class="col-md-6">
			...
			<div class="row">
		  	...
		  	<div class="form-group">
			    {!! Form::label('audience',trans('messages.audience'),['class' => 'control-label '])!!}
	            <div class="checkbox">
	            <input name="audience" type="checkbox" class="switch-input enable-show-hide" data-size="mini" data-on-text="{{trans('messages.staff')}}" data-off-text="{{trans('messages.customer')}}" value="1" {{ (isset($announcement) && $announcement->audience) ? 'checked' : '' }} data-off-value="0">
	            </div>
          	</div>

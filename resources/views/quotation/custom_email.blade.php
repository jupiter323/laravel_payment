	...
	<div class="modal-body">
		{!! Form::model($quotation,['method' => 'POST','route' => ['quotation.custom-email',$quotation->uuid] ,'class' => 'quotation-custom-email-form','id' => 'quotation-custom-email-form','data-quotation-id' => $quotation->id,'data-url' => '/template/content']) !!}
			<div class="form-group">
				{{trans('messages.customer')}} : {!! Form::label($quotation->Customer->full_name) !!}
			</div>
			<div class="form-group">
				{{trans('messages.email')}} : {!! Form::label($quotation->Customer->email) !!}
			</div>
			<div class="form-group">

			...
			<div class="col-sm-6">
			  ...
			  <div class="row">
			  	...
			  	<div class="col-md-6">
				  <div class="form-group">
				    {!! Form::label('enable_coupon',trans('messages.enable').' '.trans('messages.coupon'),['class' => 'control-label '])!!}
	                <div class="checkbox">
	                <input name="enable_coupon" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" {{ (config('config.enable_coupon') == 1) ? 'checked' : '' }} data-off-value="0">
	                </div>
	              </div>
	            </div>
			  </div>

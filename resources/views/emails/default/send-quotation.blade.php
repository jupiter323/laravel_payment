<table align="center" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td valign="top">			
				<table align="center" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td height="90" width="600" align="right">
								<p>[COMPANY_LOGO]</p>
								<p style="text-align:left;font-size:16px;"><b>Quotation Received [QUOTATION_NUMBER]</b></p>
							</td>
								...
								<table align="center"><tbody><tr><td height="10" width="560">&nbsp;</td>
												...
												<p>Hello [CUSTOMER_NAME],</p><p>A quotation with number [QUOTATION_NUMBER] is received on [QUOTATION_DATE]. Total quotation amount is <b>[QUOTATION_TOTAL]</b>.</p><p>Please visit your Quotation at [QUOTATION_LINK]</p>

<table align="center" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td valign="top">			
				<table align="center" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td height="90" width="600" align="right">
								<p>[COMPANY_LOGO]</p>
								<p style="text-align:left;font-size:16px;"><b>Quotation Rejected [QUOTATION_NUMBER]</b></p>
							</td>
								...
								<table align="center"><tbody><tr><td height="10" width="560">&nbsp;</td>
												...
												<p>Hello,</p><p>[CUSTOMER_NAME] has rejected Quotation [QUOTATION_NUMBER] dated [QUOTATION_DATE].</p><p>Please visit your Quotation at [QUOTATION_LINK]</p>

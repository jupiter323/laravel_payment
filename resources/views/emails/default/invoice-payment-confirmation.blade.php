<table align="center" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td valign="top">			
				<table align="center" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td height="90" width="600" align="right">
								<p>[COMPANY_LOGO]</p>
								<p style="text-align:left;font-size:16px;"><b>Invoice Payment Confirmation [INVOICE_NUMBER]</b></p>
							</td>
								...
								<table align="center"><tbody><tr><td height="10" width="560">&nbsp;</td>
												...
												<p>Dear [CUSTOMER_NAME],</p><p>We have received payment of [PAYMENT_AMOUNT] for Invoice [INVOICE_NUMBER] on [PAYMENT_DATE] by [PAYMENT_METHOD].</p><p>Please visit your Invoice at [INVOICE_LINK]</p>

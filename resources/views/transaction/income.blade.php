@extends('layouts.app')
	...
	@section('breadcrumb')
		<ul class="breadcrumb">
		    ...
		    <li class="active">{!! trans('messages.income') !!}</li>
		</ul>
	@stop
	...
	@section('content')
		<div class="row">
			<div class="col-sm-12 collapse" id="box-detail-filter">
				<div class="box-info">
					<h2><strong>{!! trans('messages.filter') !!}</strong> {!! trans('messages.income') !!}
					...
					{!! Form::open(['url' => 'filter','id' => 'income-filter-form','data-no-form-clear' => 1]) !!}
						<div class="col-md-3">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="reference_number">{!! trans('messages.tags') !!}</label>
								{!! Form::input('text','tags','',['class'=>'form-control','placeholder'=>trans('messages.tags')])!!}
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
						...
						<div class="col-md-3">
						  	<div class="form-group">
								<label for="income_category_id">{!! trans('messages.income').' '.trans('messages.category') !!}</label>
								{!! Form::select('income_category_id[]', $income_categories,'',['class'=>'form-control show-tick','title'=>trans('messages.select_one'),'multiple' => 'multiple','data-actions-box' => "true"])!!}
						  	</div>
						</div>
						<div class="col-md-3">
						  	<div class="form-group">
						...
						<div class="col-md-3">
						  	<div class="form-group">
								<label for="gateway">{!! trans('messages.payment') !!} Gateway</label>
								{!! Form::select('gateway[]', getPaymentGatewayList(),'',['class'=>'form-control show-tick','title'=>trans('messages.select_one'),'multiple' => 'multiple','data-actions-box' => "true"])!!}
						  	</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
						...
						<div class="col-md-3">
							<div class="checkbox">
		                        <label>
		                        	<input type="checkbox" class="icheck" name="paid_by_customer" value="1"> {{trans('messages.paid').' by '.trans('messages.customer')}}
		                        </label>
		                    </div>
							<div class="checkbox">
		                        <label>
							...
							<div class="checkbox">
		                        <label>
		                        	<input type="checkbox" class="icheck" name="withdraw_pending" value="1">{{trans('messages.withdraw').' '.trans('messages.pending')}}
		                        </label>
		                    </div>
						</div>
						<div class="clear"></div>
			...
			@if(Entrust::can('create-income'))
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong>{!! trans('messages.add_new') !!}</strong> {!! trans('messages.income') !!}
					<div class="additional-btn">
			...
			<div class="col-sm-12">
				<div class="box-info full">
					<h2><strong>{!! trans('messages.list_all') !!}</strong> {!! trans('messages.income') !!}</h2>
					<div class="additional-btn">
					...
					@include('global.datatable',['table' => $table_data['income-table']])
				</div>
			</div>
		</div>

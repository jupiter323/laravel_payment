	...
	<div class="row">
		<div class="col-md-12">
			<div class="box-info">
				...
				@include('global.notification',['message' => 'Version 1.1 Released with some new features on 4th Feb 2017. <a href="#" data-href="/whats-new" data-toggle="modal" data-target="#myModal">Click here to check Whats New?</a>' ,'type' => 'success'])
			</div>
		</div>
	</div>
@endif

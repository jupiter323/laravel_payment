			  ...
			  <div class="form-group">
			    {!! Form::label('decimal_place',trans('messages.currency').' '.trans('messages.decimal'),[])!!}
				{!! Form::input('number','decimal_place',isset($currency) ? $currency->decimal_place : '',['class'=>'form-control','placeholder'=>trans('messages.currency').' '.trans('messages.decimal')])!!}
			  </div>
			  <div class="form-group">

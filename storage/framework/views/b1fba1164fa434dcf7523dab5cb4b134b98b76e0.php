	...
	<?php $__env->startSection('breadcrumb'); ?>
		<ul class="breadcrumb">
		    ...
		    <li class="active"><?php echo trans('messages.invoice'); ?></li>
		</ul>
	...
	<?php $__env->startSection('content'); ?>
		...
		<div class="row">
			<div class="col-sm-12 collapse" id="box-detail-filter">
				<div class="box-info">
					<h2><strong><?php echo trans('messages.filter'); ?></strong> <?php echo trans('messages.invoice'); ?>
					...
					<?php echo Form::open(['url' => 'filter','id' => 'invoice-filter-form','data-no-form-clear' => 1]); ?>
						...
						<div class="row">
							...
							<div class="col-md-3">
							  	<div class="form-group">
									...
									<?php echo Form::select('status[]', $invoice_status,'',['class'=>'form-control show-tick','title'=>trans('messages.select_one'),'multiple' => 'multiple','data-actions-box' => "true"]); ?>

							  	</div>
							</div>
							<div class="col-md-3">
							  	<div class="form-group">
									<label for="to_date"><?php echo trans('messages.payment').' '.trans('messages.status'); ?></label>
									<?php echo Form::select('payment_status[]', $invoice_payment_status,'',['class'=>'form-control show-tick','title'=>trans('messages.select_one'),'multiple' => 'multiple','data-actions-box' => "true"]); ?>
							...
							<div class="col-md-6">
								...
								<div class="checkbox">
			                        ...
			                        <label>
			                        	<input type="checkbox" class="icheck" name="recurring" value="1"> <?php echo e(trans('messages.recurring')); ?>

			                        </label>
			                        <label>
			                        	<input type="checkbox" class="icheck" name="overdue" value="1"> <?php echo e(trans('messages.overdue')); ?>
			...
			<div class="col-sm-12">
				<div class="box-info full">
					<h2><strong><?php echo trans('messages.list_all'); ?></strong> <?php echo trans('messages.invoice'); ?></h2>
					<div class="additional-btn">
						...
						<?php if(Entrust::can('create-invoice')): ?>
							<a href="/invoice/create" class="btn btn-sm btn-primary"><i class="fa fa-plus icon"></i> <?php echo trans('messages.add_new'); ?></a>
						<?php endif; ?>
					</div>
					<?php echo $__env->make('global.datatable',['table' => $table_data['invoice-table']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>

...
<div class="form-group">			    
<?php echo Form::select('tax_regimen', $taxregimen,(isset($company) ? $company->tax_regimen: ''),['class'=>'form-control show-tick','title'=>trans('messages.tax_regimen')]); ?>

</div>

                       <div class="form-group">
			    <?php echo Form::label('name',trans('messages.tax_certificate'),[]); ?>

                        <div class="row">
                      <!-- <div class="col-xs-3"><?php echo Form::label('name',trans('messages.private'),[]); ?></div>-->
                         <div class="col-xs-12">
			<!--<?php echo Form::input('file','private',(isset($company) ? $company->private: ''),['class'=>'form-control','placeholder'=>trans('messages.private')]); ?>-->
<?php echo $__env->make('upload.index',['module' => 'company','upload_button' => trans('messages.private'),'module_id' => isset($company) ? $company->private: ''], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            ...
                            <div class="form-group">	
 <div class="row">
<!-- <div class="col-xs-3"><?php echo Form::label('name',trans('messages.public'),[]); ?></div>-->
                         <div class="col-xs-12">		    
				<!--<?php echo Form::input('file','public',(isset($company) ? $company->public: ''),['class'=>'form-control btn btn-primary btn-sm','placeholder'=>trans('messages.public')]); ?>-->

<?php echo $__env->make('upload.index',['module' => 'company','upload_button' => trans('messages.public'),'module_id' => isset($company) ? $company->public: ''], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
 ...
 <div class="form-group">
  <div class="row">	
<div class="col-xs-3"><?php echo Form::label('name',trans('messages.pass'),[]); ?></div>
                         <div class="col-xs-9">		    		    
				<?php echo Form::input('password','pass',(isset($company) ? $company->pass: ''),['class'=>'form-control','placeholder'=>trans('messages.pass')]); ?>
			  ...
			  <div class="form-group">
			     <?php echo Form::label('name',trans('messages.contact').' '.trans('messages.data'),[]); ?>
			  ...
			  <div class="form-group">
			     <?php echo Form::label('name',trans('messages.logo'),[]); ?>

                                    <div class="row">
                                        <div class="col-xs-6"><?php echo Form::label('name',trans('messages.logo_for_app'),[]); ?></div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                              <input type="file" class="btn btn-default file-input" name="logo" id="logo" data-buttonText="<?php echo trans('messages.select').' '.trans('messages.logo_for_app'); ?>">
 ...
 <div class="row">
           <div class="col-xs-6"><?php echo Form::label('name',trans('messages.logo_for_mail'),[]); ?></div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="file" class="btn btn-default file-input" name="email_logo" id="email_logo" data-buttonText="<?php echo trans('messages.select').' '.trans('messages.logo_for_mail'); ?>">
                                            </div>
                                        </div>
                                    </div>

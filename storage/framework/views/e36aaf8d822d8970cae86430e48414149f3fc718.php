	...
	<?php $__env->startSection('breadcrumb'); ?>
		<ul class="breadcrumb">
		    ...
		    <li class="active"><?php echo trans('messages.account').' '.trans('messages.transfer'); ?></li>
		</ul>
	...
	<?php $__env->startSection('content'); ?>
		<div class="row">
			<div class="col-sm-12 collapse" id="box-detail-filter">
				<div class="box-info">
					<h2><strong><?php echo trans('messages.filter'); ?></strong> <?php echo trans('messages.account').' '.trans('messages.transfer'); ?>
					...
					<?php echo Form::open(['url' => 'filter','id' => 'account-transfer-filter-form','data-no-form-clear' => 1]); ?>
						...
						<div class="col-md-3">
						  	<div class="form-group">
								<label for="account_id"><?php echo trans('messages.from').' '.trans('messages.account'); ?></label>
								<?php echo Form::select('from_account_id[]', $accounts,'',['class'=>'form-control show-tick','title'=>trans('messages.select_one'),'multiple' => 'multiple','data-actions-box' => "true"]); ?>

						  	</div>
						</div>
						<div class="col-md-3">
						  	<div class="form-group">
								<label for="account_id"><?php echo trans('messages.to').' '.trans('messages.account'); ?></label>
								<?php echo Form::select('to_account_id[]', $accounts,'',['class'=>'form-control show-tick','title'=>trans('messages.select_one'),'multiple' => 'multiple','data-actions-box' => "true"]); ?>
			...
			<div class="col-sm-12 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong><?php echo trans('messages.add_new'); ?></strong> <?php echo trans('messages.account').' '.trans('messages.transfer'); ?>
			...
			<div class="col-sm-12">
				<div class="box-info full">
					<h2><strong><?php echo trans('messages.list_all'); ?></strong> <?php echo trans('messages.account').' '.trans('messages.transfer'); ?></h2>
					<div class="additional-btn">
						...
						<?php if(Entrust::can('create-account-transfer')): ?>
					...
					<?php echo $__env->make('global.datatable',['table' => $table_data['account-transfer-table']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>

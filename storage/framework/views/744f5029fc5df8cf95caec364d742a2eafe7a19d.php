<table align="center" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td valign="top">			
				<table align="center" border="0" cellpadding="0" cellspacing="0"><tbody><tr><td height="90" width="600" align="right">
								<p>[COMPANY_LOGO]</p>
								<p style="text-align:left;font-size:16px;"><b>Invoice Payment Success [INVOICE_NUMBER]</b></p>
							</td>
								...
								<table align="center"><tbody><tr><td height="10" width="560">&nbsp;</td>
												...
												<p>Dear [CUSTOMER_NAME],</p><p>Payment of [PAYMENT_AMOUNT] is received via [PAYMENT_SOURCE] on [TRANSACTION_DATE] for Invoice [INVOICE_NUMBER].</p><p>Please visit your Invoice at [INVOICE_LINK]</p>

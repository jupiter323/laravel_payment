		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="box-info full">
					<h2><strong><?php echo trans('messages.list_all'); ?></strong> <?php echo trans('messages.company'); ?></h2>
					<div class="additional-btn">
						<?php if(Entrust::can('create-company')): ?>
							<a href="/company/add"><button class="btn btn-sm btn-primary"><i class="fa fa-plus icon"></i> <?php echo trans('messages.add_new'); ?></button></a>
						<?php endif; ?>
					</div>

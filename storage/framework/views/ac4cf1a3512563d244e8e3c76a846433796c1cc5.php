	...
	<?php $__env->startSection('breadcrumb'); ?>
		<ul class="breadcrumb">
		    ...
		    <li class="active"><?php echo trans('messages.item'); ?></li>
		</ul>
	...
	<?php $__env->startSection('content'); ?>
		<div class="row">
			...
			<div class="col-sm-6 collapse" id="box-detail">
				<div class="box-info">
					<h2><strong><?php echo trans('messages.add_new'); ?></strong> <?php echo trans('messages.item'); ?>
					...
					<?php echo Form::open(['route' => 'item.store','role' => 'form', 'class'=>'item-form','id' => 'item-form']); ?>
						...
						<?php echo $__env->make('item._form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					<?php echo Form::close(); ?>
			...
			<div class="col-sm-12">
				<div class="box-info full">
					<h2><strong><?php echo trans('messages.list_all'); ?></strong> <?php echo trans('messages.item'); ?></h2>
					<div class="additional-btn">
						<?php if(Entrust::can('create-item')): ?>
					...
					<?php echo $__env->make('global.datatable',['table' => $table_data['item-table']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>

	<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group">
				<?php echo Form::label('enable_login_as_user',trans('messages.enable').' '.trans('messages.login').' '.trans('messages.as').' '.trans('messages.user'),['class' => 'control-label ']); ?>

				<div class="checkbox">
					<input name="enable_login_as_user" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_login_as_user') == 1) ? 'checked' : ''); ?> data-off-value="0">
				</div>
			</div>
			<div class="form-group">
				<?php echo Form::label('login_type',trans('messages.login').' '.trans('messages.type'),['class' => 'control-label ']); ?>

				<?php echo Form::select('login_type', [
			...
			<div class="form-group">
				<?php echo Form::label('enable_account_approval',trans('messages.enable').' '.trans('messages.account').' '.trans('messages.approval'),['class' => 'control-label ']); ?>

				<div class="checkbox">
					<input name="enable_account_approval" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_account_approval') == 1) ? 'checked' : ''); ?> data-off-value="0">
				</div>
			</div>
		</div>
		<div class="col-md-4">
			...
			<div class="form-group">
				<?php echo Form::label('enable_remember_me',trans('messages.enable').' '.trans('messages.remember').' '.trans('messages.me'),['class' => 'control-label ']); ?>

				<div class="checkbox">
					<input name="enable_remember_me" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_remember_me') == 1) ? 'checked' : ''); ?> data-off-value="0">
				</div>
			</div>
			<div class="form-group">
				<?php echo Form::label('enable_reset_password',trans('messages.enable').' '.trans('messages.forgot').' '.trans('messages.password'),['class' => 'control-label ']); ?>

				<div class="checkbox">
					<input name="enable_reset_password" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_reset_password') == 1) ? 'checked' : ''); ?> data-off-value="0">
				</div>
			</div>
			<div class="form-group">
			...
			<div id="enable_recaptcha_field">
				<div class="form-group">
					<?php echo Form::label('enable_recaptcha_login',trans('messages.enable').' '.trans('messages.login').' Recaptcha',['class' => 'control-label ']); ?>

					<div class="checkbox">
						<input name="enable_recaptcha_login" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_recaptcha_login') == 1) ? 'checked' : ''); ?> data-off-value="0">
					</div>
				</div>
				<div class="form-group">
					<?php echo Form::label('enable_recaptcha_registration',trans('messages.enable').' '.trans('messages.registration').' Recaptcha',['class' => 'control-label ']); ?>

					<div class="checkbox">
						<input name="enable_recaptcha_registration" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_recaptcha_registration') == 1) ? 'checked' : ''); ?> data-off-value="0">
					</div>
				</div>
				<div class="form-group">
					<?php echo Form::label('enable_recaptcha_reset_password',trans('messages.enable').' '.trans('messages.reset').' '.trans('messages.password').' Recaptcha',['class' => 'control-label ']); ?>

					<div class="checkbox">
						<input name="enable_recaptcha_reset_password" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_recaptcha_reset_password') == 1) ? 'checked' : ''); ?> data-off-value="0">
					</div>
				</div>
				<div class="form-group">

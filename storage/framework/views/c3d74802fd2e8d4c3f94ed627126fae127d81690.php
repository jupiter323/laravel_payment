...
<div class="form-group">
														<?php echo Form::label('subtotal1',trans('messages.subtotal').' '.trans('messages.one'),['class' => ' control-label']); ?>

														<div class="checkbox">
										                	<input name="subtotal1" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.subtotal1') == 1) ? 'checked' : ''); ?> data-off-value="0">
										                </div>
													</div>
...
<div class="form-group">
														<?php echo Form::label('subtotal2',trans('messages.subtotal').' '.trans('messages.two'),['class' => ' control-label']); ?>

														<div class="checkbox">
										                	<input name="subtotal2" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.subtotal1') == 1) ? 'checked' : ''); ?> data-off-value="0">
										                </div>
													</div>


<div class="form-group">
														<?php echo Form::label('subtotal3',trans('messages.subtotal').' '.trans('messages.three'),['class' => ' control-label']); ?>

														<div class="checkbox">
										                	<input name="subtotal3" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.subtotal3') == 1) ? 'checked' : ''); ?> data-off-value="0">
										                </div>
													</div>
													<div class="form-group">
...
<div class="form-group">
														<?php echo Form::label('item_subtotal1_decimal_place',trans('messages.item_subtotal1_decimal_place'),[]); ?>

														<?php echo Form::input('number','item_subtotal1_decimal_place',(config('config.item_subtotal1_decimal_place')) ? : '',['class'=>'form-control','placeholder'=>trans('messages.item_subtotal1_decimal_place')]); ?>

													</div>


<div class="form-group">
														<?php echo Form::label('item_subtotal2_decimal_place',trans('messages.item_subtotal2_decimal_place'),[]); ?>

														<?php echo Form::input('number','item_subtotal2_decimal_place',(config('config.item_subtotal2_decimal_place')) ? : '',['class'=>'form-control','placeholder'=>trans('messages.item_subtotal2_decimal_place')]); ?>

													</div>


<div class="form-group">
														<?php echo Form::label('item_subtotal3_decimal_place',trans('messages.item_subtotal3_decimal_place'),[]); ?>

														<?php echo Form::input('number','item_subtotal3_decimal_place',(config('config.item_subtotal3_decimal_place')) ? : '',['class'=>'form-control','placeholder'=>trans('messages.item_subtotal3_decimal_place')]); ?>

...
class SendWish extends Command
{
     ...
     * @var string
     */
    protected $description = 'Send Birthday & Anniversary Wishes to Customer & Staff';
    ...
    public function handle()
    {
        ...
        foreach($birthdays as $birthday){
            if($birthday->User->hasRole(config('constant.default_customer_role')))
                $slug = 'birthday-email-customer';
            else
                $slug = 'birthday-email-staff';
        ...
        foreach($anniversaries as $anniversary){
            if($anniversary->User->hasRole(config('constant.default_customer_role')))
                $slug = 'anniversary-email-customer';
            else
                $slug = 'anniversary-email-staff';

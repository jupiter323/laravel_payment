...
Class AccController extends Controller{
    ...
    public function postUpdateApp(AccUpdateRequest $request){

    	if(!getMode())
            return response()->json(['message' => trans('messages.permission_denied'), 'status' => 'error','redirect' => '/home']);
   ...
   public function releaseLicense(){
	...
	public function index(){
		...
		$checks[] = $this->check(extension_loaded('openssl'), 'OpenSSL PHP extension enabled', 'Install and enable Open SSL extension', true);
